#' @title  Clustered Gaussian Naive Bayes Classifier
#'
#' @description Clustered Gaussian Naive Bayes Classifier.
#'
#' @param x asd
#' @param y asd
#' @param laplace asd
...
cl_gaussian_nb <- function(
  ...
  results <- gaussian_nb(x = x, y = y_new, laplace = laplace, sd_thresh = sd_thresh, var_equal = var_equal)
