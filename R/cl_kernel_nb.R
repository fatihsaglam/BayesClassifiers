#' @title  Clustered Kernel Naive Bayes Classifier
#'
#' @description Clustered Kernel Naive Bayes Classifier.
#'
#' @param x asd
#' @param y asd
#' @param laplace asd
...
cl_kernel_nb <- function(
  ...
  results <- kernel_nb(x = x, y = y_new, laplace = laplace, bw_thresh = bw_thresh, bw_method = bw_method, bw_adjust = bw_adjust)
