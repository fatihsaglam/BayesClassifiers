#' @title  Clustered Gaussian Multivariate Gaussian Bayes Classifier
#'
#' @description Clustered Gaussian Multivariate Gaussian Bayes Classifier.
#'
#' @param x asd
#' @param y asd
#' @param laplace asd
...
cl_mvgaussian_b <- function(
  ...
  results <- mvgaussian_b(x = x, y = y_new, laplace = laplace, Sigma_equal = Sigma_equal)
